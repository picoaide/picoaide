...
func (s *Server) registerExternalAPIRoutes(g *gin.RouterGroup) {
  ...
  admin.Use(s.superadminMiddleware())
  {
    ...
    admin.POST("/channels/toggle", s.handleAdminChannelsToggle)
    admin.GET("/channels/users", s.handleAdminChannelsUsersGet)
    admin.POST("/channels/users/permission", s.handleAdminChannelsUsersPermission)
    admin.POST("/channels/users/permissions", s.handleAdminChannelsUsersPermissions)
